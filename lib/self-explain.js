...
function showDiferences(opts, a, b){
    if(a === b){
        return null;
    }
    if(a == b && !opts.strict){
    ...
    if(typeof a !== typeof b && opts.strict){
        return "typeof: " + typeof a + " != " + typeof b;
    }
    return "unkown";
}

selfExplain.assert.diferences = showDiferences.bind(null, {strict:true});

selfExplain.assert.bigDiferences = showDiferences.bind(null, {strict:false});
