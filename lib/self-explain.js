...
selfExplain.assert.differences = function differences(a, b, opts, prefix){
    ...
    if(a instanceof Date && b instanceof Date) {
        ...
        var aa = new Date(a.getTime()-tzOffset).toISOString();
        var bb = new Date(b.getTime()-tzOffset).toISOString();
        ...
        return aa.slice(sliceStart, sliceEnd)+' != '+bb.slice(sliceStart, sliceEnd);
    }
