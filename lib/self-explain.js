...
function parenthesis(list, expression, fatherOperator, left){
    // console.log('op', expression.operator, BinaryPrecedence[expression.operator] , fatherOperator, BinaryPrecedence[fatherOperator])
    if(expression.operator && BinaryPrecedence[expression.operator] < BinaryPrecedence[fatherOperator]){
        list.push('"("');
    }
